  ...
  return (
    <div className="flex justify-end items-center sm:p-12 sm:py-0 sm:pb-0 p-0 py-2 pb-2 relative">
      <div className="relative group w-full max-w-[20rem] mx-auto" data-aos="fade-up" data-aos-duration="1000">
        ...
        {/* Arrows */}
        <button onClick={handlePrev} className="absolute left-0 top-1/2 -translate-y-1/2 z-20 bg-black/50 hover:bg-black/70 rounded-full p-2 transition-all duration-300 shadow-lg">
          <ChevronLeft className="w-6 h-6 text-white" />
        </button>
        <button onClick={handleNext} className="absolute right-0 top-1/2 -translate-y-1/2 z-20 bg-black/50 hover:bg-black/70 rounded-full p-2 transition-all duration-300 shadow-lg">
      ...
      <div className="w-full mx-auto pt-8 sm:pt-12 relative">
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          ...
          <div className="text-center sm:text-left">
            <h3 className="text-3xl font-bold text-[#06B6D4]" data-aos="fade-up" data-aos-duration="1000">
              Our Mission
            </h3>
            <p 
            ...
            <div className="mt-6 flex justify-center gap-8">
              <a href="#" className="text-[#06B6D4] hover:text-[#FFD6E7] font-semibold">Learn More</a>
              <a href="#" className="text-[#06B6D4] hover:text-[#FFD6E7] font-semibold">Contact Us</a>
            </div>
          </div>
