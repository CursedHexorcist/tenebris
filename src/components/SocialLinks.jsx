...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/gwen/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@gwen_",
    icon: Instagram,
    url: "https://www.instagram.com/gwen_/?hl=id",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@gwen",
    icon: Youtube,
    url: "https://www.youtube.com/@gwen",
    color: "#FF0000",
